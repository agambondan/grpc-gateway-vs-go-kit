...
type FibonacciResponse struct {
	...
	TimeMilisecond int32 `protobuf:"varint,2,opt,name=time_milisecond,json=timeMilisecond,proto3" json:"time_milisecond,omitempty"`
	TimeSecond     int32 `protobuf:"varint,3,opt,name=time_second,json=timeSecond,proto3" json:"time_second,omitempty"`
}
...
func (x *FibonacciResponse) GetTimeMilisecond() int32 {
	if x != nil {
...
func (x *FibonacciResponse) GetTimeSecond() int32 {
	if x != nil {
		return x.TimeSecond
	}
	return 0
...
func (x *LoopingRequest) GetN() int32 {
	if x != nil {
		return x.N
	}
	return 0
...
type LoopingResponse struct {
	...
	TimeMilisecond int32 `protobuf:"varint,1,opt,name=time_milisecond,json=timeMilisecond,proto3" json:"time_milisecond,omitempty"`
	TimeSecond     int32 `protobuf:"varint,2,opt,name=time_second,json=timeSecond,proto3" json:"time_second,omitempty"`
}
...
func (x *LoopingResponse) GetTimeMilisecond() int32 {
	if x != nil {
		return x.TimeMilisecond
	}
	return 0
...
func (x *LoopingResponse) GetTimeSecond() int32 {
	if x != nil {
		return x.TimeSecond
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0e, 0x74, 0x69, 0x6d, 0x65, 0x4d, 0x69, 0x6c, 0x69, 0x73, 0x65, 0x63, 0x6f,
	0x6e, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x63,
	...
	0x69, 0x6c, 0x69, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64,
